...
$MXE_PATH/usr/bin/i686-w64-mingw32.static-qmake-qt5 \
	...
	SECP256K1_INCLUDE_PATH=$HOME/shardbit/src/secp256k1/include \
	SECP256K1_LIB_PATH=$HOME/shardbit/src/secp256k1/.libs \

	QMAKE_LRELEASE=$MXE_PATH/usr/i686-w64-mingw32.static/qt5/bin/lrelease shardbit.pro
