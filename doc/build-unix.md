...
If you want to build Shardbit-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a shardbit-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the shardbit directory
BDB_PREFIX="${SHARDBIT_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure Shardbit Core to use our own-built instance of BDB
cd $SHARDBIT_ROOT
./autogen.sh
...
2) The release is built with GCC and then "strip shardbitd" to strip the debug
symbols, which reduces the executable size by about 90%.


To Build Shardbitd with compile script
---------------------
...
Security
---------------------
To help make your shardbit installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, shardbit should be built with a non-executable stack
